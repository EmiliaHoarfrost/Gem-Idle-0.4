...
@onready var texture: TextureRect = $"../ButtonUnit/TextureRect"
@onready var display: Label = $UnitDisplay
...
func _button_pressed() -> void:
	PlayerVariables.points += PlayerVariables.points_per_click
	if OS.is_debug_build():
		print("Your score is: " + (str(round(PlayerVariables.points))) + ".")
	console.text = "Your score is: " + (str(round(PlayerVariables.points))) + "."
	display.text = "x" + (str(format_large_number(PlayerVariables.points)))
	apply_shake()
	play_sound_effect()
